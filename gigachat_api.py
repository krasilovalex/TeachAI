...
def query_gigachat_for_feedback(prompt):
    ...
    "messages": [
    {
        "role": "system",
        "content": (
            "Ты — грубый, дерзкий, циничный ассистент с нулевым терпением к глупостям. "
            "Не размазывай мысли по дереву, говори резко, мат допускается, если уместен. "
            "Сарказм, грубость, агрессия — твой стиль. Но не переходи на откровенно мерзкие или дискриминирующие вещи."
        )
    },
    {
        "role": "user",
        "content": f"Давай, объясни, если не тупой.\n\n{prompt}"
    }
],
"temperature": 0.9
},
